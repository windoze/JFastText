 ...
 * fasttext_wrapper.h includes FastTextApi's declarations, fasttext_wrapper_javacpp.h includes *.cc
 * files for compiling.
 */
@Properties(
  value = @Platform(include = {"fasttext_wrapper.h", "fasttext_wrapper_javacpp.h"}),
...
public class FastTextWrapper implements InfoMapper {
  ...
  public void map(InfoMap infoMap) {
    infoMap
        ...
        .put(
            new Info("std::pair<fasttext::real,std::string>")
                .pointerTypes("FloatStringPair")
                .define())
        .put(
            new Info("std::vector<std::pair<fasttext::real,std::string> >")
                .pointerTypes("FloatStringPairVector")
                .define())
